    ...
    public class Matematika : IMatematika
    {
        public int Bagi(int a, int b)
        {
            ...
            catch (Exception ex)
            {
                ...
                mf.Kode = "Inputan Yan Anda Masukan Salah";
        ...
        //Membuat koordinat hasil lalu menjumlahkan xa dengan xb, y dengan yb lalu dimasukkan ke hasil
